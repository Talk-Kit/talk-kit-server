    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST,"/api/user-service/emailCheck").permitAll()
                        .requestMatchers(HttpMethod.POST,"/api/user-service/userIdCheck").permitAll()
                        .requestMatchers(HttpMethod.POST,"/api/user-service/userNicknameCheck").permitAll()
